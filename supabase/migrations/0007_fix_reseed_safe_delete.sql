-- Keep the atomic r2 reseed compatible with projects using safeupdate.
...
begin
  ...
  delete from public.fund_ledger_entries where true;
  ...
  delete from public.fund_sources where true;
